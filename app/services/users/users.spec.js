describe('Users factory', function() {
  ...
  // A set of tets for our Users.all() method
  describe('.all()', function() {
    ...
    // A test to verify that calling all() retrns the array of users we hard-coded above
  ...
  describe('findById(id)', function() {
    ...
    // A test to verify that alling findById() with an id, in this case '2' returns a single users
